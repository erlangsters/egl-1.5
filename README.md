...
To understand how a particular piece of EGL code in C translates in this
binding, you will need to understand the API mapping.

## API mapping

read the
documentation. The test suites is also a great source of inspiration.

To be written.

Because OpenGL is thread-sensitive, you will need to learn how the EGL binding
solves it at the BEAM level.
