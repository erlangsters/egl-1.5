...
> [!NOTE]
> EGL version 1.5 is the last and final version. It's the reason why
...
> If you're using macOS or Windows, you will want to use [ANGLE](https://github.com/google/angle) which you're placing in discoverable paths.
