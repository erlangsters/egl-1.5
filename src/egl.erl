...
-module(egl).
-moduledoc """
EGL binding for the BEAM.

To be written.

It implements the API of EGL 1.5, adjusted for BEAM (Erlang language).
Knowledge of the EGL API in C is assumed, as this module is a direct binding to the C API.
